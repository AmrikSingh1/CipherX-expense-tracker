          ...
          children: [
            ...
            if (filteredCategories.isNotEmpty)
              CategorySelector(
                ...
                onAddCategory: () {
                  // In a real app, you'd show a dialog to create a new category
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(content: Text('Create new category functionality coming soon!')),
                  );
                },
              ),
            const SizedBox(height: 24),
            ...
            SwitchListTile(
              ...
              subtitle: const Text('Will this transaction repeat in the future?'),
              value: _isRecurring,
              onChanged: (value) {
                setState(() {
                  _isRecurring = value;
